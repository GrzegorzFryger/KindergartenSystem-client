...
export class FinancesComponent implements OnInit {
  ...
  // Other properties
  public isTotalBalancePositive: boolean;
  public isChildBalancePositive: boolean;
  ...
  ngOnInit(): void {
    ...
    this.selectedChildService.selectedChild.subscribe(selectedChild => {
      ...
      this.balancesForAllChildren.subscribe(balance => {
        ...
        this.isChildBalancePositive = this.balanceForCurrentChild.balance >= 0;
      });
  ...
  private initializeSumOfAllBalances(u: Account): void {
    ...
    .pipe(
      ...
      map(response => {
        ...
        this.isTotalBalancePositive = response.balance >= 0;
        return response;
      })
    );
  }
